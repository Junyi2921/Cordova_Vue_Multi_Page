...
<script>
    ...
    export default {
        data() {
            return {
                webname : 5464, 'list' : [{
                    'id' : 0, 'name' : '地图测试', 'url' : '../vuxDemo/map.html'
                }, {
                    'id' : 1, 'name' : 'alert弹窗', 'url' : '../vuxDemo/alert.html'
                }, {
                    'id' : 2, 'name' : 'Calendar时间选择', 'url' : '../vuxDemo/calendar.html'
                }, {
                    'id' : 3, 'name' : 'button按钮', 'url' : '../vuxDemo/button.html'
                }, {
                    'id' : 4, 'name' : 'Native请求测试', 'url' : '../vuxDemo/request.html'
                }, {
                    "id" : 5, name : "点击进入电商平台", url : "../home/carMall.html"
                }]
            }
        }, components : {
            Cell, Group, Divider
